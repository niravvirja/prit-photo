            ...
            return (
              <div
                ...
                style={{
                  ...
                  left: '50%',
                  top: '50%',
                  marginLeft: '-150px', // Half of image width for perfect centering
                  marginTop: isMobile ? '-200px' : '-150px', // Half of image height
                  ...getSlideStyle(index)
                }}
              >
                <div className="relative group">
                  <img
                    src={imageSrc}
                    alt={slide.title}
                    className="object-cover rounded-xl shadow-2xl transition-all duration-300
                      w-80 h-96 md:w-96 md:h-64"
                    draggable={false}
                  />
                  ...
                  {getSlidePosition(index) === 0 && (
                    <div className="absolute inset-0 rounded-xl shadow-2xl shadow-white/10 pointer-events-none" />
                  )}
